<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Menu.aspx.vb" Inherits="UsuariosRegistrados.Menu" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Button ID="Button1" runat="server" Height="40px" Text="Button" Width="154px" />
        </p>
    </form>
</body>
</html>
